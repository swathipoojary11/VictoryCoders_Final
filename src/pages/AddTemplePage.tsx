...
import { Mail, MapPin, Send, Church, ArrowLeft } from "lucide-react";
...
const AddTemplePage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Main Content */}
      <main className="flex-1 pt-20 pb-20 spiritual-gradient">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            {/* Back Button */}
            <Link to="/" className="inline-flex items-center gap-2 text-primary hover:text-primary/80 mb-6 transition-smooth">
