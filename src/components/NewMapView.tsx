  ...
  const getMarkerIcon = (isSelected: boolean) => {
    return L.divIcon({
      ...
      html: `
        ...
        }" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="filter: drop-shadow(0 1px 2px rgba(0,0,0,0.2)); transform: scale(${isSelected ? 1.25 : 1}); transition: transform 0.2s;">
        ...
        {userLocation && (
          <Marker
            ...
            icon={L.divIcon({
              ...
              html: '<div class="w-4 h-4 bg-blue-500 rounded-full border-2 border-white shadow-lg animate-[pulse_2s_ease-in-out_infinite]"></div>',
              iconSize: [16, 16],
              iconAnchor: [8, 8],
            })}
          />
